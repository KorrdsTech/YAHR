...
public class SpiderEntity extends TamableAnimal {
	public SpiderEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(YahrYouAreHerobrineRebornModEntities.SPIDER.get(), world);
	}
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		SpiderEntity retval = YahrYouAreHerobrineRebornModEntities.SPIDER.get().create(serverWorld);
	...
	public boolean isFood(ItemStack stack) {
		return List.of(Items.NETHER_WART).contains(stack.getItem());
	}

	public static void init() {
		SpawnPlacements.register(YahrYouAreHerobrineRebornModEntities.SPIDER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
