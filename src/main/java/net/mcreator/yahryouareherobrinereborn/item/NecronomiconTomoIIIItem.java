...
import net.mcreator.yahryouareherobrinereborn.procedures.NecronomiconTomoIIIRightclickedProcedure;
import net.mcreator.yahryouareherobrinereborn.init.YahrYouAreHerobrineRebornModTabs;

public class NecronomiconTomoIIIItem extends Item {
	public NecronomiconTomoIIIItem() {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		NecronomiconTomoIIIRightclickedProcedure.execute(entity);
		return ar;
	}
}
