...
import net.mcreator.yahryouareherobrinereborn.procedures.NecronomiconRightclickedOnBlockProcedure;
...
public class NecronomiconItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level world, Player entity, InteractionHand hand) {
		...
		NecronomiconRightclickedOnBlockProcedure.execute(world, x, y, z, entity);
		return ar;
	}
}
